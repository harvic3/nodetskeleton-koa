# NodeTSkeleton with KoaJs <img height="50" src="https://i.ibb.co/BZkYR9H/esqueletots.png" alt="esqueletonts" border="0">

> The official documentation for this implementation with KoaJs can be found in the basic template of the project. 
